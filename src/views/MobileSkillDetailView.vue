...
<style scoped>
.mobile-skill-page{min-height:100vh;padding:16px;background:#fff8f1;color:#1f2937}.mobile-brand{display:flex;align-items:center;gap:8px;margin-bottom:12px;color:#e86600;font-size:16px}.mobile-brand__mark{display:grid;width:28px;height:28px;place-items:center;border-radius:8px;color:#fff;background:#e86600;font-weight:800}.mobile-skill-card{margin-top:12px;border-radius:14px;background:#fff}.mobile-skill-card h1{margin:12px 0 4px;font-size:24px}.mobile-skill-card p{line-height:1.6;color:#64748b}.skill-key{font-size:12px;color:#e86600!important}.mobile-state{padding:48px 0;text-align:center;color:#64748b}.mobile-skill-card :deep(.t-select){margin-bottom:12px}.mobile-skill-card :deep(.t-button--primary){background:#e86600;border-color:#e86600}
.install-guide{display:grid;gap:8px;margin:4px 0 14px;padding:13px;border:1px solid #f2d8bf;border-radius:8px;background:#fff8f1;color:#334155}.install-guide strong{font-size:13px}.install-guide__target{color:#e86600;font-size:12px}.install-location{display:grid;gap:4px}.install-location span{color:#64748b;font-size:11px}.install-location code{overflow-wrap:anywhere;padding:7px 8px;border-radius:5px;background:#fff;color:#7c3f12;font:12px/1.45 ui-monospace,SFMono-Regular,Menlo,monospace}.install-guide small{color:#94a3b8;font-size:11px;line-height:1.5}
</style>
