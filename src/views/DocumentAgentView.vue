...
<style scoped>
.agent-page{display:grid;gap:16px}.agent-page header{display:flex;gap:18px;align-items:flex-start}.agent-page header h1{margin:4px 0}.agent-page header p,.agent-page header small,.muted{color:#718096}.layout{display:grid;grid-template-columns:minmax(0,1fr) 300px;gap:16px}.card{background:#fff;border:1px solid #e6e1da;border-radius:14px;padding:16px}.chat{padding:0;overflow:hidden}.timeline{height:58vh;overflow:auto;padding:20px;display:grid;align-content:start;gap:10px;background:#faf9f7}.bubble{max-width:82%;padding:12px 14px;border-radius:13px}.bubble small{color:#718096}.bubble p{white-space:pre-wrap;margin:6px 0}.user{justify-self:end;background:#fff0e7}.assistant{justify-self:start;background:#fff;border:1px solid #e5e7eb}.error-text{color:#c53030}.message-actions{display:flex;align-items:center;gap:8px;margin-top:8px}.composer{padding:14px;border-top:1px solid #e5e7eb}.composer textarea{width:100%;min-height:88px;box-sizing:border-box;border:1px solid #d8dde6;border-radius:10px;padding:10px;resize:vertical}.composer>div{display:flex;justify-content:flex-end;gap:8px;margin-top:8px}button{border:1px solid #d8dde6;background:#fff;border-radius:8px;padding:8px 12px;cursor:pointer}.primary{background:#ff5a1f;color:#fff;border-color:#ff5a1f}.tag{display:inline-flex;align-items:center;gap:4px;padding:5px 8px;margin:3px;background:#fff0e7;color:#c84616;border-radius:6px}.tag button{border:0;background:transparent;padding:0;color:inherit}.context-card{display:grid;gap:8px}.context-search{display:grid;grid-template-columns:1fr auto auto;gap:6px}.context-search.wiki-search{grid-template-columns:1fr auto}.context-actions{display:flex;align-items:center;justify-content:space-between;gap:8px}.context-search input{min-width:0;border:1px solid #d8dde6;border-radius:8px;padding:8px}.feishu-results{display:grid;gap:5px;max-height:180px;overflow:auto}.feishu-option{display:flex;justify-content:space-between;text-align:left;gap:6px;width:100%;font-size:12px}.feishu-option small{color:#718096}.feishu-option.selected{border-color:#ff5a1f;background:#fff5ed}.selected-context{display:flex;flex-wrap:wrap;gap:3px}.artifact{display:grid;gap:5px;padding:10px 0;border-top:1px solid #eee}.artifact small{color:#718096}.empty{text-align:center;color:#718096;padding:60px 20px}@media(max-width:900px){.layout{grid-template-columns:1fr}.timeline{height:50vh}}
</style>
