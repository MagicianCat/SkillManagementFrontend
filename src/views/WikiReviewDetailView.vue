...
<style scoped>
.detail-loading{margin-top:18px}.detail-header-card{margin-top:18px}.detail-header{display:flex;align-items:flex-start;justify-content:space-between;gap:16px}.detail-header h1{margin:4px 0 10px;color:var(--text-1);font-size:24px}.detail-meta{margin:5px 0;color:var(--text-2);font-size:13px}.detail-grid{display:grid;grid-template-columns:minmax(0,1fr) 320px;gap:16px;margin-top:16px}.detail-main,.detail-side{display:grid;align-content:start;gap:16px}.markdown-content{max-height:680px;overflow:auto;margin:0;padding:16px;border-radius:8px;color:var(--text-1);background:var(--surface-2)}.detail-copy{margin:0;color:var(--text-2);font-size:13px;line-height:1.8}.detail-side :deep(.t-space){width:100%}@media(max-width:900px){.detail-grid{grid-template-columns:1fr}.detail-header{flex-direction:column}}
</style>
