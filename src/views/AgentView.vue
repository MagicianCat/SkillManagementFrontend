...
<style scoped>
.agent-page{display:flex;height:100%;min-height:0;background:#fff}.agent-sessions{width:240px;flex:0 0 240px;overflow:auto;border-right:1px solid #ece1d2;background:#fff}.agent-sessions__header{display:flex;height:52px;align-items:center;justify-content:space-between;padding:0 14px;border-bottom:1px solid #ece1d2;font-size:13px}.agent-sessions__header button{border:0;background:transparent;font-size:20px;cursor:pointer}.session-item{display:grid;width:calc(100% - 12px);gap:3px;margin:6px;padding:10px;border:0;border-radius:7px;color:#64748b;background:transparent;text-align:left;cursor:pointer}.session-item:hover,.session-item.is-active{color:#e86600;background:#fff1e0}.session-item strong{overflow:hidden;font-size:12px;text-overflow:ellipsis;white-space:nowrap}.session-item small{display:flex;align-items:center;justify-content:space-between;font-size:10px}.agent-workspace{display:flex;min-width:0;flex:1;flex-direction:column}.agent-workspace>header{display:flex;height:76px;align-items:center;justify-content:space-between;padding:0 22px;border-bottom:1px solid #ece1d2}.agent-workspace h1{margin:0;color:#0f172a;font-size:18px}.agent-workspace p{margin:3px 0 0;color:#94a3b8;font-size:11px}.agent-selectors{display:flex;gap:10px;padding:7px 10px;border:1px solid #f3dfca;border-radius:12px;background:#fffaf4;box-shadow:0 3px 12px rgb(218 116 30 / 8%)}.agent-selectors .t-select{width:132px}.agent-knowledge-notice{display:flex;justify-content:space-between;gap:14px;padding:9px 22px;color:#9a4a0a;background:#fff4e8;font-size:12px;line-height:1.5}.agent-knowledge-notice a{flex:0 0 auto;color:#e86600;font-weight:700}.agent-context{width:260px;flex:0 0 260px;padding:18px;border-left:1px solid #ece1d2;background:#fff}.agent-context h2{margin:0 0 14px;color:#334155;font-size:13px}.context-card{margin-bottom:12px;padding:12px;border:1px solid #ece1d2;border-radius:8px}.context-card strong{color:#334155;font-size:12px}.context-card p{margin:6px 0 0;color:#64748b;font-size:11px;line-height:1.6}.market-link{display:block;padding:9px;border-radius:7px;color:#fff;background:#e86600;font-size:12px;text-align:center;text-decoration:none}@media(max-width:1050px){.agent-context{display:none}}@media(max-width:760px){.agent-sessions{display:none}.agent-workspace>header{height:auto;align-items:stretch;flex-direction:column;gap:10px;padding:14px}.agent-selectors{justify-content:stretch}.agent-selectors .t-select{width:50%}}
</style>
