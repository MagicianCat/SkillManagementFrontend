...
<style scoped>
.wiki-page{padding:30px 34px;color:var(--text-1)}.wiki-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:20px}.wiki-heading h1{margin:5px 0 8px;font-size:28px}.wiki-heading p:not(.eyebrow){margin:0;color:var(--text-2);font-size:13px}.wiki-alert{margin:18px 0;padding:12px 14px;border-radius:8px;color:var(--warning);background:var(--warning-soft)}.wiki-toolbar{display:flex;gap:10px;margin:24px 0}.wiki-toolbar .t-select{width:220px}.wiki-toolbar .t-input{width:300px}.wiki-layout{display:grid;grid-template-columns:280px minmax(0,1fr);gap:18px;min-height:570px}.wiki-list,.wiki-reader{border:1px solid var(--border-1);border-radius:12px;background:var(--surface-1);backdrop-filter:blur(12px)}.wiki-list{padding:12px}.wiki-list__head,.revision-heading,.reader-heading,.editor-heading{display:flex;align-items:center;justify-content:space-between;gap:14px}.wiki-list__head{padding:8px 8px 14px;border-bottom:1px solid var(--border-1)}.wiki-list__head span,.revision-heading span{color:var(--text-3);font-size:12px}.wiki-list-item{display:grid;width:100%;gap:5px;margin-top:6px;padding:12px 10px;border:0;border-radius:8px;color:var(--text-2);background:transparent;text-align:left;cursor:pointer}.wiki-list-item:hover,.wiki-list-item.active{color:var(--accent-400);background:var(--accent-softer)}.wiki-list-item small{color:var(--text-3)}.wiki-empty{padding:30px 10px;color:var(--text-3);font-size:13px;text-align:center}.wiki-empty--large{padding-top:220px}.wiki-reader{padding:26px}.reader-heading h2{margin:5px 0;font-size:24px}.reader-heading p{margin:5px 0;color:var(--text-3);font-size:12px}.reader-actions{display:flex;gap:8px;flex-wrap:wrap}.pending-review-badge{display:inline-block;margin-left:8px;padding:3px 7px;border-radius:5px;color:var(--warning);background:var(--warning-soft)}.reader-links{display:flex;flex-wrap:wrap;gap:8px;margin:20px 0}.reader-links a{padding:5px 9px;border-radius:5px;color:var(--accent-400);background:var(--accent-softer);font-size:12px;text-decoration:none}.markdown-content{min-height:280px;margin:0;padding:20px;border-radius:8px;color:var(--text-1);background:var(--surface-2);overflow:auto}.revision-panel{margin-top:24px;padding-top:18px;border-top:1px solid var(--border-1)}.revision-row{display:flex;align-items:center;gap:12px;padding:10px 0;border-bottom:1px solid var(--border-1);color:var(--text-2);font-size:12px}.revision-row time{margin-right:auto;color:var(--text-3)}.editor-heading{margin-bottom:16px}.editor-heading .t-input{width:420px}.editor-actions{display:flex;gap:8px}.editor-fields{display:flex;gap:10px;margin-bottom:14px}.editor-fields .t-select{min-width:200px}.upload-row{display:flex;align-items:center;gap:12px;margin-bottom:12px;color:var(--text-3);font-size:12px}.promotion-mask{position:fixed;inset:0;z-index:20;display:grid;place-items:center;padding:20px;background:rgb(4 8 14 / 62%);backdrop-filter:blur(4px)}.promotion-dialog{width:min(100%,520px);padding:24px;border-radius:14px;background:var(--surface-1);backdrop-filter:blur(12px);box-shadow:var(--shadow-lg)}.promotion-dialog h2{margin:0 0 8px}.promotion-dialog p{margin:0 0 16px;color:var(--text-2);font-size:13px;line-height:1.6}.promotion-dialog textarea{box-sizing:border-box;width:100%;padding:10px;border:1px solid var(--border-1);border-radius:8px;resize:vertical}.promotion-actions{display:flex;justify-content:flex-end;gap:8px;margin-top:16px}@media(max-width:800px){.wiki-page{padding:20px}.wiki-layout{grid-template-columns:1fr}.wiki-toolbar{flex-wrap:wrap}.wiki-toolbar .t-input,.wiki-toolbar .t-select{width:100%}.editor-heading .t-input{width:100%}.editor-heading{align-items:stretch;flex-direction:column}.editor-fields{flex-direction:column}}
</style>
